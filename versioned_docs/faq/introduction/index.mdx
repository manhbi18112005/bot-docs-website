...
This bot is a 24/7-working bot which was made by [**No Name Studio**](https://www.nnsvn.me) . Please support it for more new features in the forthcoming days. The main prefix of this bot is **`nn_`** . I wish this bot would be developed completely in the future. It's 100% free for server owners, and only takes less than 5 minutes to set up.
...
**English**: [`en.bot.nnsvn.me`](https://en.bot.nnsvn.me)

**Vietnamese**: [`vn.bot.nnsvn.me`](https://vn.bot.nnsvn.me)
