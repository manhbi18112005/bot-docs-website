...
After selecting the "Cookies" option, select `botapp.nonamestudio.xyz` from the list and remove those cookies, do the same for `discordapp.com` when you reach the Discord website.
...
If you are still having issues logging out, feel free to join our [support server](https://bot.nonamestudio.xyz/discord) for more instructions.