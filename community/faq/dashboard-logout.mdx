...
After selecting the "Cookies" option, select `bot.nonamestudio.xyz` from the list and remove those cookies, do the same for `discordapp.com` when you reach the Discord website.
