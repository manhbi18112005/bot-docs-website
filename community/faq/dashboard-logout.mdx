...
After selecting the "Cookies" option, select `botapp.nnsvn.me` from the list and remove those cookies, do the same for `discordapp.com` when you reach the Discord website.
